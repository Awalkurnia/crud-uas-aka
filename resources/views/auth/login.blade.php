...
<body style="background: linear-gradient(rgba(0,0,0,0.6), rgba(0,0,0,0.6)), url('{{ secure_asset('assets/bg1.jpg') }}') no-repeat center center fixed; background-size: cover;">
    <div class="card-glass">
        <img src="{{ secure_asset('assets/image/logo2.jpg') }}" alt="Logo" class="logo-login">
